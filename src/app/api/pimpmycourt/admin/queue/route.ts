...
export async function GET(request: Request) {
  ...
  const { data, error } = await supabase
    .from("terrains")
    .select("id, latitude, longitude, ville, departement, statut, photo_avant_url, nb_confirmations, nb_paniers, nb_filets_a_remplacer, nom_terrain, nom, age, contact_email, contact_instagram, contact_tiktok, prenom, commentaire, created_at")
