          ...
          <div className="flex-1 grid grid-cols-4 gap-2 sm:gap-3">
            {reels.map((reel, i) => (
              ...
              >
                ...
                {(reel.reach != null || reel.like_count != null || reel.comments_count != null) && (
                    ...
                    <div className="flex items-center gap-3">
                      {reel.reach != null && (
                        <div className="flex flex-col items-center">
                          ...
                          <span className="font-heading text-[10px] font-bold italic text-white mt-0.5">{formatViews(reel.reach)}</span>
                        </div>
                      )}
                      {reel.like_count != null && (
                        <div className="flex flex-col items-center">
                          ...
                          <span className="font-heading text-[10px] font-bold italic text-white mt-0.5">{formatViews(reel.like_count)}</span>
                        </div>
                      )}
