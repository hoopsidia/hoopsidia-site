                  ...
                  <div className="flex items-center gap-4">
                    {reel.video_views != null && (
                      <div className="flex flex-col items-center">
                        ...
                        <span className="font-heading text-xs text-white mt-0.5">{formatViews(reel.video_views)}</span>
                      </div>
                    )}
                    {reel.like_count != null && (
                      <div className="flex flex-col items-center">
                        ...
                        <span className="font-heading text-xs text-white mt-0.5">{formatViews(reel.like_count)}</span>
                      </div>
                    )}
                    {reel.comments_count != null && (
                      <div className="flex flex-col items-center">
                        ...
                        <span className="font-heading text-xs text-white mt-0.5">{formatViews(reel.comments_count)}</span>
                      </div>
                    )}
                  </div>
                </div>
